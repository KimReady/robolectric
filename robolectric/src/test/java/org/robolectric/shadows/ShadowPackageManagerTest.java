...
public class ShadowPackageManagerTest {
  ...
  public void
    ...
    assertThat(setting.getSuspendedAppExtras().getString("key")).isEqualTo("value");
    assertThat(setting.getSuspendedLauncherExtras().getInt("number")).isEqualTo(7);
    assertThat(setting.getDialogInfo().getDialogMessage()).isEqualTo("Dialog message");
    assertThat(setting.getDialogInfo().getIconResId()).isEqualTo(R.drawable.an_image);
    assertThat(setting.getDialogInfo().getTitleResId()).isEqualTo(R.string.greeting);
    assertThat(setting.getDialogInfo().getNeutralButtonTextResId()).isEqualTo(R.string.copy);
